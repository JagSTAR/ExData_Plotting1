...
##Plot 4.2
plot(Data3$ClassTime,Data3$Voltage, type = "l", ylab = "Voltage",xlab = "datetime")
##Plot 4.3
...
##Plot 4.4
plot(Data3$ClassTime,Data3$Global_reactive_power, type = "l", ylab = "Global_active_power",xlab = "datetime")
